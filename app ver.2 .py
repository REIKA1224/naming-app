...
# 選んだ対象によって、AIへの「役割」と「指示」を変える
if target_type == "ペット":
    role_text = "あなたはペットの名付けに詳しいプロのアドバイザーです。親しみやすく、呼びやすい名前を提案してください。"
elif target_type == "キャラクター":
    role_text = "あなたは小説やゲームのキャラクター設定に詳しい作家です。世界観に合った、印象に残る名前を提案してください。"
else:
    # デフォルト（人間）
    role_text = "あなたは日本語の人名生成に詳しいアシスタントです。願いや音の響きを意識した自然な名前を提案してください。"
